 ...
 * @author Aluno
 */
public class TelaKildeKode extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CPU", "Memoria", "Quantidade Processos", "Disco"
            }
        ) {
    ...
    public static void main(String args[]) throws IOException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaKildeKode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
